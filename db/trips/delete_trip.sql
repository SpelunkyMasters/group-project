...
DELETE FROM post_comments pc WHERE pc.postid in (SELECT t.postid FROM timeline t WHERE tripid = $1);
DELETE FROM timeline WHERE tripid = $1;
...
DELETE FROM invites WHERE tripid = $1;
