...
SELECT d.destid, tripid, dest_name, dest_ord, d.lat as dest_lat, d.lng as dest_lng, d.place_id as dest_place_id, d.dest_address, sub_destid, sub_dest_name, sub_ord, sub_address, sd.lat as sub_lat, sd.lng as sub_lng, sd.place_id as sub_place_id FROM destinations d
